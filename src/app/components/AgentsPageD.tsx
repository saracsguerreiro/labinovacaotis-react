      ...
      >
        ...
        <div style={{
          ...
          <div style={{ textAlign: 'center', padding: '8px 16px 10px', flexShrink: 0 }}>
            ...
            {/* Caixa de destaque do título do agente */}
            <div style={{
...
export default function AgentsPageD() {
  ...
  return (
    <div style={{
      minHeight: '100vh',
      /* Mesmo fundo do banner IdeaHub na Home */
